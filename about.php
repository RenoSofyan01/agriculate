                ...
                <li data-aos="fade-up" data-aos-delay="200">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      harga, dan perubahan permintaan.
                    </p>
                  </div>
                </li>
                <li data-aos="fade-up" data-aos-delay="300">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      merespons kebutuhan pangan diberbagai wilayah.
                    </p>
                  </div>
                </li>
              </ul>
        ...
        <div class="row gy-4 mt-4">
          ...
          <div class="col-lg-8">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="nama" class="form-control" id="name" placeholder="Nama"  value="<?php echo $nama; ?>" required>
                </div>
            ...
            <div class="star-input">
              ...
              <div class="form-group mt-3">
                <textarea class="form-control" name="testi" rows="5" placeholder="Berikan testimonialmu!" required></textarea>
              </div>
              <div class="my-3">

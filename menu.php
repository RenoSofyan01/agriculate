...
<header id="header" class="header d-flex align-items-center fixed-top">
  ...
  <div style="text-align: center; margin-top: 130px;" >
        ...
        ?>
          <button class="btn btn-dark <?php echo $__menuAktif == 'registrasi' ? 'active' : ''?>" onclick="window.location.href='daftarforum.php'" >Daftar</button>
          <button class="btn btn-dark <?php echo $__menuAktif == 'login' ? 'active' : ''?>" onclick="window.location.href='loginforum.php'">Masuk</button>
        <?php } else {
          ...
          echo '<button class="btn btn-dark" onclick="window.location.href=\'indexforum.php\'">Lihat Forum</button>';
